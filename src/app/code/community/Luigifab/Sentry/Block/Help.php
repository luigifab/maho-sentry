...
class Luigifab_Sentry_Block_Help extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface {
	...
	public function render(Varien_Data_Form_Element_Abstract $element) {
		...
		$msg = '<a href="https://github.com/luigifab/maho-sentry" style="margin:0;">github.com/luigifab/maho-sentry</a>';

		$src = 'app/code/core/Mage/Core/Model/App.php';
		$src = is_file($src) ? $src : 'vendor/mahocommerce/maho/app/code/core/Mage/Core/Model/App.php';
